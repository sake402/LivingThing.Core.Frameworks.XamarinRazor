...
var WebViewRenderer = /** @class */ (function () {
    ...
    WebViewRenderer.prototype.getPhysicalParent = function (model) {
    ...
    WebViewRenderer.prototype.removeRecursive = function (model) {
        ...
        if (parent) {
            ...
            parentElementModel.nodes = parentElementModel.nodes.filter(function (n) { return !model.nodes.some(function (node) { return node == n; }); });
        }
        model.nodes.forEach(function (n) { var _a; return (_a = n.parentNode) === null || _a === void 0 ? void 0 : _a.removeChild(n); });
    ...
    WebViewRenderer.prototype.patch = function (newModel) {
        ...
        if (newModel.type === DOMType.Remove) {
            ...
            var parent_1 = this.getPhysicalParent(newModel); // this.mapping[newModel.parentId] as DOMElementModel;
            ...
            var referenceNode_1 = reference_1 === null || reference_1 === void 0 ? void 0 : reference_1.nodes[0];
            ...
            switch (existingModel.type) {
                ...
                case DOMType.Element: {
                    ...
                    var element = existingModel.nodes[0];
                    ...
                    for (var _a = 0, removedAttributes_1 = removedAttributes; _a < removedAttributes_1.length; _a++) {
                        var key = removedAttributes_1[_a];
    ...
    WebViewRenderer.prototype.update = function (models, forceFirstUpdate) {
    ...
    WebViewRenderer.prototype.execute = function (fn, param) {
