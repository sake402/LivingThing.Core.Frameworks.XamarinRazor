...
{
    public partial class ShellContent : ComponentToXamarinBridge<Xamarin.Forms.ShellContent, ShellContent>
    {
        public ShellContent()
        {
        }
        public ShellContent(Xamarin.Forms.ShellContent _element):base(_element)
        {
        }
		...
		[Parameter] public System.Object Content { set => P.Content = value; get => P.Content; }
		[Parameter] public Xamarin.Forms.Binding BindContent { set { P.SetBinding(Xamarin.Forms.ShellContent.ContentProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate ContentTemplate { set => P.ContentTemplate = value; get => P.ContentTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindContentTemplate { set { P.SetBinding(Xamarin.Forms.ShellContent.ContentTemplateProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource FlyoutIcon { set => P.FlyoutIcon = value; get => P.FlyoutIcon; }
		[Parameter] public Xamarin.Forms.Binding BindFlyoutIcon { set { P.SetBinding(Xamarin.Forms.ShellContent.FlyoutIconProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource Icon { set => P.Icon = value; get => P.Icon; }
		[Parameter] public Xamarin.Forms.Binding BindIcon { set { P.SetBinding(Xamarin.Forms.ShellContent.IconProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.ShellContent.IsEnabledProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindTitle { set { P.SetBinding(Xamarin.Forms.ShellContent.TitleProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.ShellContent.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.ShellContent.IsTabStopProperty, value); } }
		[Parameter] public Xamarin.Forms.Style Style { set => P.Style = value; get => P.Style; }
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.ShellContent.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.ShellContent.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.ShellContent.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.ShellContent.BindingContextProperty, value); } }
    }
}
