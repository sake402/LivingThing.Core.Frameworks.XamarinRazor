...
{
    public partial class TextCell : ComponentToXamarinBridge<Xamarin.Forms.TextCell, TextCell>
    {
        public TextCell()
        {
        }
        public TextCell(Xamarin.Forms.TextCell _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindCommand { set { P.SetBinding(Xamarin.Forms.TextCell.CommandProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCommandParameter { set { P.SetBinding(Xamarin.Forms.TextCell.CommandParameterProperty, value); } }
		[Parameter] public System.String Detail { set => P.Detail = value; get => P.Detail; }
		[Parameter] public Xamarin.Forms.Binding BindDetail { set { P.SetBinding(Xamarin.Forms.TextCell.DetailProperty, value); } }
		[Parameter] public Xamarin.Forms.Color DetailColor { set => P.DetailColor = value; get => P.DetailColor; }
		[Parameter] public Xamarin.Forms.Binding BindDetailColor { set { P.SetBinding(Xamarin.Forms.TextCell.DetailColorProperty, value); } }
		[Parameter] public System.String Text { set => P.Text = value; get => P.Text; }
		[Parameter] public Xamarin.Forms.Binding BindText { set { P.SetBinding(Xamarin.Forms.TextCell.TextProperty, value); } }
		[Parameter] public Xamarin.Forms.Color TextColor { set => P.TextColor = value; get => P.TextColor; }
		[Parameter] public Xamarin.Forms.Binding BindTextColor { set { P.SetBinding(Xamarin.Forms.TextCell.TextColorProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.TextCell.IsEnabledProperty, value); } }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.TextCell.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.TextCell.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.TextCell.BindingContextProperty, value); } }
    }
}
