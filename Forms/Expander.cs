...
{
    public partial class Expander : ComponentToXamarinLayoutBridge<Xamarin.Forms.Expander, Expander>
    {
        public Expander()
        {
        }
        public Expander(Xamarin.Forms.Expander _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.View Header { set => P.Header = value; get => P.Header; }
		[Parameter] public Xamarin.Forms.Binding BindHeader { set { P.SetBinding(Xamarin.Forms.Expander.HeaderProperty, value); } }
		[Parameter] public Xamarin.Forms.View Content { set => P.Content = value; get => P.Content; }
		[Parameter] public Xamarin.Forms.Binding BindContent { set { P.SetBinding(Xamarin.Forms.Expander.ContentProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate ContentTemplate { set => P.ContentTemplate = value; get => P.ContentTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindContentTemplate { set { P.SetBinding(Xamarin.Forms.Expander.ContentTemplateProperty, value); } }
		[Parameter] public System.Boolean IsExpanded { set => P.IsExpanded = value; get => P.IsExpanded; }
		[Parameter] public Xamarin.Forms.Binding BindIsExpanded { set { P.SetBinding(Xamarin.Forms.Expander.IsExpandedProperty, value); } }
		[Parameter] public System.UInt32 ExpandAnimationLength { set => P.ExpandAnimationLength = value; get => P.ExpandAnimationLength; }
		[Parameter] public Xamarin.Forms.Binding BindExpandAnimationLength { set { P.SetBinding(Xamarin.Forms.Expander.ExpandAnimationLengthProperty, value); } }
		[Parameter] public System.UInt32 CollapseAnimationLength { set => P.CollapseAnimationLength = value; get => P.CollapseAnimationLength; }
		[Parameter] public Xamarin.Forms.Binding BindCollapseAnimationLength { set { P.SetBinding(Xamarin.Forms.Expander.CollapseAnimationLengthProperty, value); } }
		[Parameter] public Xamarin.Forms.Easing ExpandAnimationEasing { set => P.ExpandAnimationEasing = value; get => P.ExpandAnimationEasing; }
		[Parameter] public Xamarin.Forms.Binding BindExpandAnimationEasing { set { P.SetBinding(Xamarin.Forms.Expander.ExpandAnimationEasingProperty, value); } }
		[Parameter] public Xamarin.Forms.Easing CollapseAnimationEasing { set => P.CollapseAnimationEasing = value; get => P.CollapseAnimationEasing; }
		[Parameter] public Xamarin.Forms.Binding BindCollapseAnimationEasing { set { P.SetBinding(Xamarin.Forms.Expander.CollapseAnimationEasingProperty, value); } }
		[Parameter] public Xamarin.Forms.ExpanderState State { set => P.State = value; get => P.State; }
		[Parameter] public Xamarin.Forms.Binding BindState { set { P.SetBinding(Xamarin.Forms.Expander.StateProperty, value); } }
		[Parameter] public System.Object CommandParameter { set => P.CommandParameter = value; get => P.CommandParameter; }
		[Parameter] public Xamarin.Forms.Binding BindCommandParameter { set { P.SetBinding(Xamarin.Forms.Expander.CommandParameterProperty, value); } }
		[Parameter] public System.Windows.Input.ICommand Command { set => P.Command = value; get => P.Command; }
		[Parameter] public Xamarin.Forms.Binding BindCommand { set { P.SetBinding(Xamarin.Forms.Expander.CommandProperty, value); } }
		[Parameter] public EventCallback OnCommand { set { Command = new Xamarin.Forms.Command(async () => { await value.InvokeAsync(this); }); } }
		[Parameter] public System.Windows.Input.ICommand ForceUpdateSizeCommand { set => P.ForceUpdateSizeCommand = value; get => P.ForceUpdateSizeCommand; }
		[Parameter] public Xamarin.Forms.Binding BindForceUpdateSizeCommand { set { P.SetBinding(Xamarin.Forms.Expander.ForceUpdateSizeCommandProperty, value); } }
		[Parameter] public EventCallback OnForceUpdateSizeCommand { set { ForceUpdateSizeCommand = new Xamarin.Forms.Command(async () => { await value.InvokeAsync(this); }); } }
		[Parameter] public Xamarin.Forms.ControlTemplate ControlTemplate { set => P.ControlTemplate = value; get => P.ControlTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindControlTemplate { set { P.SetBinding(Xamarin.Forms.Expander.ControlTemplateProperty, value); } }
		[Parameter] public System.Boolean IsClippedToBounds { set => P.IsClippedToBounds = value; get => P.IsClippedToBounds; }
		[Parameter] public Xamarin.Forms.Binding BindIsClippedToBounds { set { P.SetBinding(Xamarin.Forms.Expander.IsClippedToBoundsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Padding { set => P.Padding = value; get => P.Padding; }
		[Parameter] public Xamarin.Forms.Binding BindPadding { set { P.SetBinding(Xamarin.Forms.Expander.PaddingProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCascadeInputTransparent { set { P.SetBinding(Xamarin.Forms.Expander.CascadeInputTransparentProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.Expander.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.Expander.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.Expander.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.Expander.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.Expander.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.Expander.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.Expander.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.Expander.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.Expander.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.Expander.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.Expander.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.Expander.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.Expander.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.Expander.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.Expander.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.Expander.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.Expander.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.Expander.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.Expander.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.Expander.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.Expander.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.Expander.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.Expander.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.Expander.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.Expander.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.Expander.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.Expander.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.Expander.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.Expander.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.Expander.BindingContextProperty, value); } }
    }
}
