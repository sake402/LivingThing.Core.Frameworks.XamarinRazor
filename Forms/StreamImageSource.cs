...
{
    public partial class StreamImageSource : ComponentToXamarinBridge<Xamarin.Forms.StreamImageSource, StreamImageSource>
    {
        public StreamImageSource()
        {
        }
        public StreamImageSource(Xamarin.Forms.StreamImageSource _element):base(_element)
        {
        }
		...
		[Parameter] public System.Func<System.Threading.CancellationToken, System.Threading.Tasks.Task<System.IO.Stream>> Stream { set => P.Stream = value; get => P.Stream; }
		[Parameter] public Xamarin.Forms.Binding BindStream { set { P.SetBinding(Xamarin.Forms.StreamImageSource.StreamProperty, value); } }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.StreamImageSource.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.StreamImageSource.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.StreamImageSource.BindingContextProperty, value); } }
    }
}
