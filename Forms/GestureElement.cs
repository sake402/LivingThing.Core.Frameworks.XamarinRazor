...
{
    public partial class GestureElement : ComponentToXamarinBridge<Xamarin.Forms.GestureElement, GestureElement>
    {
        public GestureElement()
        {
        }
        public GestureElement(Xamarin.Forms.GestureElement _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.GestureElement.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.GestureElement.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.GestureElement.BindingContextProperty, value); } }
    }
}
