...
{
    public partial class FileMediaSource : ComponentToXamarinBridge<Xamarin.Forms.FileMediaSource, FileMediaSource>
    {
        public FileMediaSource()
        {
        }
        public FileMediaSource(Xamarin.Forms.FileMediaSource _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindFile { set { P.SetBinding(Xamarin.Forms.FileMediaSource.FileProperty, value); } }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.FileMediaSource.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.FileMediaSource.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.FileMediaSource.BindingContextProperty, value); } }
    }
}
