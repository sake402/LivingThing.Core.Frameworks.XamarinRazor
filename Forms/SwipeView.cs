...
{
    public partial class SwipeView : ComponentToXamarinLayoutBridge<Xamarin.Forms.SwipeView, SwipeView>
    {
        public SwipeView()
        {
        }
        public SwipeView(Xamarin.Forms.SwipeView _element):base(_element)
        {
        }

		[Parameter] public System.EventHandler<Xamarin.Forms.SwipeStartedEventArgs> SwipeStarted { set => P.SwipeStarted += value; }
		EventCallback<Xamarin.Forms.SwipeStartedEventArgs> _onSwipeStarted;
		[Parameter] public EventCallback<Xamarin.Forms.SwipeStartedEventArgs> OnSwipeStarted { set { if (!_onSwipeStarted.HasDelegate) { P.SwipeStarted += (s, e) => _onSwipeStarted.InvokeAsync(e); } _onSwipeStarted = value; } }
		[Parameter] public System.EventHandler<Xamarin.Forms.SwipeChangingEventArgs> SwipeChanging { set => P.SwipeChanging += value; }
		EventCallback<Xamarin.Forms.SwipeChangingEventArgs> _onSwipeChanging;
		[Parameter] public EventCallback<Xamarin.Forms.SwipeChangingEventArgs> OnSwipeChanging { set { if (!_onSwipeChanging.HasDelegate) { P.SwipeChanging += (s, e) => _onSwipeChanging.InvokeAsync(e); } _onSwipeChanging = value; } }
		[Parameter] public System.EventHandler<Xamarin.Forms.SwipeEndedEventArgs> SwipeEnded { set => P.SwipeEnded += value; }
		EventCallback<Xamarin.Forms.SwipeEndedEventArgs> _onSwipeEnded;
		[Parameter] public EventCallback<Xamarin.Forms.SwipeEndedEventArgs> OnSwipeEnded { set { if (!_onSwipeEnded.HasDelegate) { P.SwipeEnded += (s, e) => _onSwipeEnded.InvokeAsync(e); } _onSwipeEnded = value; } }
		[Parameter] public System.EventHandler<Xamarin.Forms.OpenSwipeEventArgs> OpenRequested { set => P.OpenRequested += value; }
		EventCallback<Xamarin.Forms.OpenSwipeEventArgs> _onOpenRequested;
		[Parameter] public EventCallback<Xamarin.Forms.OpenSwipeEventArgs> OnOpenRequested { set { if (!_onOpenRequested.HasDelegate) { P.OpenRequested += (s, e) => _onOpenRequested.InvokeAsync(e); } _onOpenRequested = value; } }
		...
		[Parameter] public Xamarin.Forms.SwipeItems LeftItems { set => P.LeftItems = value; get => P.LeftItems; }
		[Parameter] public Xamarin.Forms.Binding BindLeftItems { set { P.SetBinding(Xamarin.Forms.SwipeView.LeftItemsProperty, value); } }
		[Parameter] public Xamarin.Forms.SwipeItems RightItems { set => P.RightItems = value; get => P.RightItems; }
		[Parameter] public Xamarin.Forms.Binding BindRightItems { set { P.SetBinding(Xamarin.Forms.SwipeView.RightItemsProperty, value); } }
		[Parameter] public Xamarin.Forms.SwipeItems TopItems { set => P.TopItems = value; get => P.TopItems; }
		[Parameter] public Xamarin.Forms.Binding BindTopItems { set { P.SetBinding(Xamarin.Forms.SwipeView.TopItemsProperty, value); } }
		[Parameter] public Xamarin.Forms.SwipeItems BottomItems { set => P.BottomItems = value; get => P.BottomItems; }
		[Parameter] public Xamarin.Forms.Binding BindBottomItems { set { P.SetBinding(Xamarin.Forms.SwipeView.BottomItemsProperty, value); } }
		[Parameter] public Xamarin.Forms.View Content { set => P.Content = value; get => P.Content; }
		[Parameter] public Xamarin.Forms.Binding BindContent { set { P.SetBinding(Xamarin.Forms.SwipeView.ContentProperty, value); } }
		[Parameter] public Xamarin.Forms.ControlTemplate ControlTemplate { set => P.ControlTemplate = value; get => P.ControlTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindControlTemplate { set { P.SetBinding(Xamarin.Forms.SwipeView.ControlTemplateProperty, value); } }
		[Parameter] public System.Boolean IsClippedToBounds { set => P.IsClippedToBounds = value; get => P.IsClippedToBounds; }
		[Parameter] public Xamarin.Forms.Binding BindIsClippedToBounds { set { P.SetBinding(Xamarin.Forms.SwipeView.IsClippedToBoundsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Padding { set => P.Padding = value; get => P.Padding; }
		[Parameter] public Xamarin.Forms.Binding BindPadding { set { P.SetBinding(Xamarin.Forms.SwipeView.PaddingProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCascadeInputTransparent { set { P.SetBinding(Xamarin.Forms.SwipeView.CascadeInputTransparentProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.SwipeView.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.SwipeView.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.SwipeView.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.SwipeView.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.SwipeView.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.SwipeView.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.SwipeView.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.SwipeView.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.SwipeView.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.SwipeView.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.SwipeView.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.SwipeView.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.SwipeView.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.SwipeView.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.SwipeView.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.SwipeView.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.SwipeView.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.SwipeView.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.SwipeView.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.SwipeView.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.SwipeView.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.SwipeView.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.SwipeView.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.SwipeView.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.SwipeView.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.SwipeView.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.SwipeView.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.SwipeView.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.SwipeView.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.SwipeView.BindingContextProperty, value); } }
    }
}
