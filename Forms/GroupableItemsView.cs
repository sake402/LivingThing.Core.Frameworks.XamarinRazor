...
{
    public partial class GroupableItemsView : ComponentToXamarinBridge<Xamarin.Forms.GroupableItemsView, GroupableItemsView>
    {
        public GroupableItemsView()
        {
        }
        public GroupableItemsView(Xamarin.Forms.GroupableItemsView _element):base(_element)
        {
        }
		...
		[Parameter] public System.Boolean IsGrouped { set => P.IsGrouped = value; get => P.IsGrouped; }
		[Parameter] public Xamarin.Forms.Binding BindIsGrouped { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.IsGroupedProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindGroupHeaderTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.GroupHeaderTemplateProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate GroupFooterTemplate { set => P.GroupFooterTemplate = value; get => P.GroupFooterTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindGroupFooterTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.GroupFooterTemplateProperty, value); } }
		[Parameter] public System.Object SelectedItem { set => P.SelectedItem = value; get => P.SelectedItem; }
		[Parameter] public Xamarin.Forms.Binding BindSelectedItem { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.SelectedItemProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindSelectedItems { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.SelectedItemsProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindSelectionChangedCommand { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.SelectionChangedCommandProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindSelectionChangedCommandParameter { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.SelectionChangedCommandParameterProperty, value); } }
		[Parameter] public Xamarin.Forms.SelectionMode SelectionMode { set => P.SelectionMode = value; get => P.SelectionMode; }
		[Parameter] public Xamarin.Forms.Binding BindSelectionMode { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.SelectionModeProperty, value); } }
		[Parameter] public System.Object Header { set => P.Header = value; get => P.Header; }
		[Parameter] public Xamarin.Forms.Binding BindHeader { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.HeaderProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate HeaderTemplate { set => P.HeaderTemplate = value; get => P.HeaderTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindHeaderTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.HeaderTemplateProperty, value); } }
		[Parameter] public System.Object Footer { set => P.Footer = value; get => P.Footer; }
		[Parameter] public Xamarin.Forms.Binding BindFooter { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.FooterProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate FooterTemplate { set => P.FooterTemplate = value; get => P.FooterTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindFooterTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.FooterTemplateProperty, value); } }
		[Parameter] public Xamarin.Forms.IItemsLayout ItemsLayout { set => P.ItemsLayout = value; get => P.ItemsLayout; }
		[Parameter] public Xamarin.Forms.Binding BindItemsLayout { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ItemsLayoutProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindItemSizingStrategy { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ItemSizingStrategyProperty, value); } }
		[Parameter] public System.Object EmptyView { set => P.EmptyView = value; get => P.EmptyView; }
		[Parameter] public Xamarin.Forms.Binding BindEmptyView { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.EmptyViewProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate EmptyViewTemplate { set => P.EmptyViewTemplate = value; get => P.EmptyViewTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindEmptyViewTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.EmptyViewTemplateProperty, value); } }
		[Parameter] public System.Collections.IEnumerable ItemsSource { set => P.ItemsSource = value; get => P.ItemsSource; }
		[Parameter] public Xamarin.Forms.Binding BindItemsSource { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ItemsSourceProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindRemainingItemsThresholdReachedCommand { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RemainingItemsThresholdReachedCommandProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindRemainingItemsThresholdReachedCommandParameter { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RemainingItemsThresholdReachedCommandParameterProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindHorizontalScrollBarVisibility { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.HorizontalScrollBarVisibilityProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindVerticalScrollBarVisibility { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.VerticalScrollBarVisibilityProperty, value); } }
		[Parameter] public System.Int32 RemainingItemsThreshold { set => P.RemainingItemsThreshold = value; get => P.RemainingItemsThreshold; }
		[Parameter] public Xamarin.Forms.Binding BindRemainingItemsThreshold { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RemainingItemsThresholdProperty, value); } }
		[Parameter] public Xamarin.Forms.DataTemplate ItemTemplate { set => P.ItemTemplate = value; get => P.ItemTemplate; }
		[Parameter] public Xamarin.Forms.Binding BindItemTemplate { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ItemTemplateProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindItemsUpdatingScrollMode { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ItemsUpdatingScrollModeProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.GroupableItemsView.BindingContextProperty, value); } }
    }
}
