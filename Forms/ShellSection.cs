...
{
    public partial class ShellSection : ComponentToXamarinBridge<Xamarin.Forms.ShellSection, ShellSection>
    {
        public ShellSection()
        {
        }
        public ShellSection(Xamarin.Forms.ShellSection _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.ShellContent CurrentItem { set => P.CurrentItem = value; get => P.CurrentItem; }
		[Parameter] public Xamarin.Forms.Binding BindCurrentItem { set { P.SetBinding(Xamarin.Forms.ShellSection.CurrentItemProperty, value); } }
		[Parameter] public Xamarin.Forms.FlyoutDisplayOptions FlyoutDisplayOptions { set => P.FlyoutDisplayOptions = value; get => P.FlyoutDisplayOptions; }
		[Parameter] public Xamarin.Forms.Binding BindFlyoutDisplayOptions { set { P.SetBinding(Xamarin.Forms.ShellSection.FlyoutDisplayOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource FlyoutIcon { set => P.FlyoutIcon = value; get => P.FlyoutIcon; }
		[Parameter] public Xamarin.Forms.Binding BindFlyoutIcon { set { P.SetBinding(Xamarin.Forms.ShellSection.FlyoutIconProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource Icon { set => P.Icon = value; get => P.Icon; }
		[Parameter] public Xamarin.Forms.Binding BindIcon { set { P.SetBinding(Xamarin.Forms.ShellSection.IconProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.ShellSection.IsEnabledProperty, value); } }
		[Parameter] public System.String Route { set => P.Route = value; get => P.Route; }
		[Parameter] public System.String Title { set => P.Title = value; get => P.Title; }
		[Parameter] public Xamarin.Forms.Binding BindTitle { set { P.SetBinding(Xamarin.Forms.ShellSection.TitleProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.ShellSection.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.ShellSection.IsTabStopProperty, value); } }
		[Parameter] public Xamarin.Forms.Style Style { set => P.Style = value; get => P.Style; }
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.ShellSection.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.ShellSection.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.ShellSection.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.ShellSection.BindingContextProperty, value); } }
    }
}
