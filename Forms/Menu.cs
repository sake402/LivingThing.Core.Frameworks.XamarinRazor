...
{
    public partial class Menu : ComponentToXamarinBridge<Xamarin.Forms.Menu, Menu>
    {
        public Menu()
        {
        }
        public Menu(Xamarin.Forms.Menu _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Menu this[System.Int32 index] { set => P[index] = value; get => P[index]; }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.Menu.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.Menu.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.Menu.BindingContextProperty, value); } }
    }
}
