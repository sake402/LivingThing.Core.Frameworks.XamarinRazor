...
{
    public partial class UriMediaSource : ComponentToXamarinBridge<Xamarin.Forms.UriMediaSource, UriMediaSource>
    {
        public UriMediaSource()
        {
        }
        public UriMediaSource(Xamarin.Forms.UriMediaSource _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindUri { set { P.SetBinding(Xamarin.Forms.UriMediaSource.UriProperty, value); } }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.UriMediaSource.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.UriMediaSource.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.UriMediaSource.BindingContextProperty, value); } }
    }
}
