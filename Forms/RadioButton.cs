...
{
    public partial class RadioButton : ComponentToXamarinBridge<Xamarin.Forms.RadioButton, RadioButton>
    {
        public RadioButton()
        {
        }
        public RadioButton(Xamarin.Forms.RadioButton _element):base(_element)
        {
        }

		[Parameter] public System.EventHandler<Xamarin.Forms.CheckedChangedEventArgs> CheckedChanged { set => P.CheckedChanged += value; }
		EventCallback<Xamarin.Forms.CheckedChangedEventArgs> _onCheckedChanged;
		[Parameter] public EventCallback<Xamarin.Forms.CheckedChangedEventArgs> OnCheckedChanged { set { if (!_onCheckedChanged.HasDelegate) { P.CheckedChanged += (s, e) => _onCheckedChanged.InvokeAsync(e); } _onCheckedChanged = value; } }
		...
		[Parameter] public System.Boolean IsChecked { set => P.IsChecked = value; get => P.IsChecked; }
		[Parameter] public Xamarin.Forms.Binding BindIsChecked { set { P.SetBinding(Xamarin.Forms.RadioButton.IsCheckedProperty, value); } }
		[Parameter] public System.String GroupName { set => P.GroupName = value; get => P.GroupName; }
		[Parameter] public Xamarin.Forms.Binding BindGroupName { set { P.SetBinding(Xamarin.Forms.RadioButton.GroupNameProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Padding { set => P.Padding = value; get => P.Padding; }
		[Parameter] public Xamarin.Forms.Binding BindPadding { set { P.SetBinding(Xamarin.Forms.RadioButton.PaddingProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BorderColor { set => P.BorderColor = value; get => P.BorderColor; }
		[Parameter] public Xamarin.Forms.Binding BindBorderColor { set { P.SetBinding(Xamarin.Forms.RadioButton.BorderColorProperty, value); } }
		[Parameter] public System.Int32 CornerRadius { set => P.CornerRadius = value; get => P.CornerRadius; }
		[Parameter] public Xamarin.Forms.Binding BindCornerRadius { set { P.SetBinding(Xamarin.Forms.RadioButton.CornerRadiusProperty, value); } }
		[Parameter] public System.Double BorderWidth { set => P.BorderWidth = value; get => P.BorderWidth; }
		[Parameter] public Xamarin.Forms.Binding BindBorderWidth { set { P.SetBinding(Xamarin.Forms.RadioButton.BorderWidthProperty, value); } }
		[Parameter] public Xamarin.Forms.Button.ButtonContentLayout ContentLayout { set => P.ContentLayout = value; get => P.ContentLayout; }
		[Parameter] public Xamarin.Forms.Binding BindContentLayout { set { P.SetBinding(Xamarin.Forms.RadioButton.ContentLayoutProperty, value); } }
		[Parameter] public System.Windows.Input.ICommand Command { set => P.Command = value; get => P.Command; }
		[Parameter] public Xamarin.Forms.Binding BindCommand { set { P.SetBinding(Xamarin.Forms.RadioButton.CommandProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindCommandParameter { set { P.SetBinding(Xamarin.Forms.RadioButton.CommandParameterProperty, value); } }
		[Parameter] public Xamarin.Forms.Font Font { set => P.Font = value; get => P.Font; }
		[Parameter] public Xamarin.Forms.Binding BindFont { set { P.SetBinding(Xamarin.Forms.RadioButton.FontProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource ImageSource { set => P.ImageSource = value; get => P.ImageSource; }
		[Parameter] public Xamarin.Forms.Binding BindImageSource { set { P.SetBinding(Xamarin.Forms.RadioButton.ImageSourceProperty, value); } }
		[Parameter] public System.String Text { set => P.Text = value; get => P.Text; }
		[Parameter] public Xamarin.Forms.Binding BindText { set { P.SetBinding(Xamarin.Forms.RadioButton.TextProperty, value); } }
		[Parameter] public Xamarin.Forms.Color TextColor { set => P.TextColor = value; get => P.TextColor; }
		[Parameter] public Xamarin.Forms.Binding BindTextColor { set { P.SetBinding(Xamarin.Forms.RadioButton.TextColorProperty, value); } }
		[Parameter] public System.Double CharacterSpacing { set => P.CharacterSpacing = value; get => P.CharacterSpacing; }
		[Parameter] public Xamarin.Forms.Binding BindCharacterSpacing { set { P.SetBinding(Xamarin.Forms.RadioButton.CharacterSpacingProperty, value); } }
		[Parameter] public Xamarin.Forms.FontAttributes FontAttributes { set => P.FontAttributes = value; get => P.FontAttributes; }
		[Parameter] public Xamarin.Forms.Binding BindFontAttributes { set { P.SetBinding(Xamarin.Forms.RadioButton.FontAttributesProperty, value); } }
		[Parameter] public System.String FontFamily { set => P.FontFamily = value; get => P.FontFamily; }
		[Parameter] public Xamarin.Forms.Binding BindFontFamily { set { P.SetBinding(Xamarin.Forms.RadioButton.FontFamilyProperty, value); } }
		[Parameter] public System.Double FontSize { set => P.FontSize = value; get => P.FontSize; }
		[Parameter] public Xamarin.Forms.Binding BindFontSize { set { P.SetBinding(Xamarin.Forms.RadioButton.FontSizeProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.RadioButton.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.RadioButton.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.RadioButton.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.RadioButton.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.RadioButton.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.RadioButton.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.RadioButton.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.RadioButton.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.RadioButton.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.RadioButton.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.RadioButton.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.RadioButton.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.RadioButton.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.RadioButton.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.RadioButton.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.RadioButton.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.RadioButton.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.RadioButton.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.RadioButton.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.RadioButton.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.RadioButton.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.RadioButton.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.RadioButton.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.RadioButton.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.RadioButton.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.RadioButton.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.RadioButton.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.RadioButton.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.RadioButton.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.RadioButton.BindingContextProperty, value); } }
    }
}
