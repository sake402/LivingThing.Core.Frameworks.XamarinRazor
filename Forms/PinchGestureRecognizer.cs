...
{
    public partial class PinchGestureRecognizer : ComponentToXamarinBridge<Xamarin.Forms.PinchGestureRecognizer, PinchGestureRecognizer>
    {
        public PinchGestureRecognizer()
        {
        }
        public PinchGestureRecognizer(Xamarin.Forms.PinchGestureRecognizer _element):base(_element)
        {
        }

		[Parameter] public System.EventHandler<Xamarin.Forms.PinchGestureUpdatedEventArgs> PinchUpdated { set => P.PinchUpdated += value; }
		EventCallback<Xamarin.Forms.PinchGestureUpdatedEventArgs> _onPinchUpdated;
		[Parameter] public EventCallback<Xamarin.Forms.PinchGestureUpdatedEventArgs> OnPinchUpdated { set { if (!_onPinchUpdated.HasDelegate) { P.PinchUpdated += (s, e) => _onPinchUpdated.InvokeAsync(e); } _onPinchUpdated = value; } }
		...
		[Parameter] public System.Boolean IsPinching { set => P.IsPinching = value; get => P.IsPinching; }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.PinchGestureRecognizer.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.PinchGestureRecognizer.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.PinchGestureRecognizer.BindingContextProperty, value); } }
    }
}
