...
{
    public partial class BaseShellItem : ComponentToXamarinBridge<Xamarin.Forms.BaseShellItem, BaseShellItem>
    {
        public BaseShellItem()
        {
        }
        public BaseShellItem(Xamarin.Forms.BaseShellItem _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindFlyoutIcon { set { P.SetBinding(Xamarin.Forms.BaseShellItem.FlyoutIconProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource Icon { set => P.Icon = value; get => P.Icon; }
		[Parameter] public Xamarin.Forms.Binding BindIcon { set { P.SetBinding(Xamarin.Forms.BaseShellItem.IconProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.BaseShellItem.IsEnabledProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindTitle { set { P.SetBinding(Xamarin.Forms.BaseShellItem.TitleProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.BaseShellItem.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.BaseShellItem.IsTabStopProperty, value); } }
		[Parameter] public Xamarin.Forms.Style Style { set => P.Style = value; get => P.Style; }
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.BaseShellItem.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.BaseShellItem.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.BaseShellItem.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.BaseShellItem.BindingContextProperty, value); } }
    }
}
