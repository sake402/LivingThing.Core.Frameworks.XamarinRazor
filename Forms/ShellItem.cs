...
{
    public partial class ShellItem : ComponentToXamarinBridge<Xamarin.Forms.ShellItem, ShellItem>
    {
        public ShellItem()
        {
        }
        public ShellItem(Xamarin.Forms.ShellItem _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.ShellSection CurrentItem { set => P.CurrentItem = value; get => P.CurrentItem; }
		[Parameter] public Xamarin.Forms.Binding BindCurrentItem { set { P.SetBinding(Xamarin.Forms.ShellItem.CurrentItemProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindFlyoutDisplayOptions { set { P.SetBinding(Xamarin.Forms.ShellItem.FlyoutDisplayOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource FlyoutIcon { set => P.FlyoutIcon = value; get => P.FlyoutIcon; }
		[Parameter] public Xamarin.Forms.Binding BindFlyoutIcon { set { P.SetBinding(Xamarin.Forms.ShellItem.FlyoutIconProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource Icon { set => P.Icon = value; get => P.Icon; }
		[Parameter] public Xamarin.Forms.Binding BindIcon { set { P.SetBinding(Xamarin.Forms.ShellItem.IconProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.ShellItem.IsEnabledProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindTitle { set { P.SetBinding(Xamarin.Forms.ShellItem.TitleProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.ShellItem.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.ShellItem.IsTabStopProperty, value); } }
		[Parameter] public Xamarin.Forms.Style Style { set => P.Style = value; get => P.Style; }
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.ShellItem.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.ShellItem.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.ShellItem.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.ShellItem.BindingContextProperty, value); } }
    }
}
