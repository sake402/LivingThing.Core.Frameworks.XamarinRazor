...
{
    public partial class FormattedString : ComponentToXamarinBridge<Xamarin.Forms.FormattedString, FormattedString>
    {
        public FormattedString()
        {
        }
        public FormattedString(Xamarin.Forms.FormattedString _element):base(_element)
        {
        }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.FormattedString.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.FormattedString.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.FormattedString.BindingContextProperty, value); } }
    }
}
