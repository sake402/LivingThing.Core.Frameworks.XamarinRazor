...
{
    public partial class Slider : ComponentToXamarinBridge<Xamarin.Forms.Slider, Slider>
    {
        public Slider()
        {
        }
        public Slider(Xamarin.Forms.Slider _element):base(_element)
        {
        }

		[Parameter] public System.EventHandler<Xamarin.Forms.ValueChangedEventArgs> ValueChanged { set => P.ValueChanged += value; }
		EventCallback<Xamarin.Forms.ValueChangedEventArgs> _onValueChanged;
		[Parameter] public EventCallback<Xamarin.Forms.ValueChangedEventArgs> OnValueChanged { set { if (!_onValueChanged.HasDelegate) { P.ValueChanged += (s, e) => _onValueChanged.InvokeAsync(e); } _onValueChanged = value; } }
		...
		[Parameter] public Xamarin.Forms.Color MinimumTrackColor { set => P.MinimumTrackColor = value; get => P.MinimumTrackColor; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumTrackColor { set { P.SetBinding(Xamarin.Forms.Slider.MinimumTrackColorProperty, value); } }
		[Parameter] public Xamarin.Forms.Color MaximumTrackColor { set => P.MaximumTrackColor = value; get => P.MaximumTrackColor; }
		[Parameter] public Xamarin.Forms.Binding BindMaximumTrackColor { set { P.SetBinding(Xamarin.Forms.Slider.MaximumTrackColorProperty, value); } }
		[Parameter] public Xamarin.Forms.Color ThumbColor { set => P.ThumbColor = value; get => P.ThumbColor; }
		[Parameter] public Xamarin.Forms.Binding BindThumbColor { set { P.SetBinding(Xamarin.Forms.Slider.ThumbColorProperty, value); } }
		[Parameter] public Xamarin.Forms.ImageSource ThumbImageSource { set => P.ThumbImageSource = value; get => P.ThumbImageSource; }
		[Parameter] public Xamarin.Forms.Binding BindThumbImageSource { set { P.SetBinding(Xamarin.Forms.Slider.ThumbImageSourceProperty, value); } }
		[Parameter] public System.Windows.Input.ICommand DragStartedCommand { set => P.DragStartedCommand = value; get => P.DragStartedCommand; }
		[Parameter] public Xamarin.Forms.Binding BindDragStartedCommand { set { P.SetBinding(Xamarin.Forms.Slider.DragStartedCommandProperty, value); } }
		[Parameter] public EventCallback OnDragStartedCommand { set { DragStartedCommand = new Xamarin.Forms.Command(async () => { await value.InvokeAsync(this); }); } }
		[Parameter] public System.Windows.Input.ICommand DragCompletedCommand { set => P.DragCompletedCommand = value; get => P.DragCompletedCommand; }
		[Parameter] public Xamarin.Forms.Binding BindDragCompletedCommand { set { P.SetBinding(Xamarin.Forms.Slider.DragCompletedCommandProperty, value); } }
		[Parameter] public EventCallback OnDragCompletedCommand { set { DragCompletedCommand = new Xamarin.Forms.Command(async () => { await value.InvokeAsync(this); }); } }
		[Parameter] public System.Double Maximum { set => P.Maximum = value; get => P.Maximum; }
		[Parameter] public Xamarin.Forms.Binding BindMaximum { set { P.SetBinding(Xamarin.Forms.Slider.MaximumProperty, value); } }
		[Parameter] public System.Double Minimum { set => P.Minimum = value; get => P.Minimum; }
		[Parameter] public Xamarin.Forms.Binding BindMinimum { set { P.SetBinding(Xamarin.Forms.Slider.MinimumProperty, value); } }
		[Parameter] public System.Double Value { set => P.Value = value; get => P.Value; }
		[Parameter] public Xamarin.Forms.Binding BindValue { set { P.SetBinding(Xamarin.Forms.Slider.ValueProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions HorizontalOptions { set => P.HorizontalOptions = value; get => P.HorizontalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindHorizontalOptions { set { P.SetBinding(Xamarin.Forms.Slider.HorizontalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.Thickness Margin { set => P.Margin = value; get => P.Margin; }
		[Parameter] public Xamarin.Forms.Binding BindMargin { set { P.SetBinding(Xamarin.Forms.Slider.MarginProperty, value); } }
		[Parameter] public Xamarin.Forms.LayoutOptions VerticalOptions { set => P.VerticalOptions = value; get => P.VerticalOptions; }
		[Parameter] public Xamarin.Forms.Binding BindVerticalOptions { set { P.SetBinding(Xamarin.Forms.Slider.VerticalOptionsProperty, value); } }
		[Parameter] public Xamarin.Forms.IVisual Visual { set => P.Visual = value; get => P.Visual; }
		[Parameter] public Xamarin.Forms.Binding BindVisual { set { P.SetBinding(Xamarin.Forms.Slider.VisualProperty, value); } }
		[Parameter] public Xamarin.Forms.FlowDirection FlowDirection { set => P.FlowDirection = value; get => P.FlowDirection; }
		[Parameter] public Xamarin.Forms.Binding BindFlowDirection { set { P.SetBinding(Xamarin.Forms.Slider.FlowDirectionProperty, value); } }
		[Parameter] public System.Double AnchorX { set => P.AnchorX = value; get => P.AnchorX; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorX { set { P.SetBinding(Xamarin.Forms.Slider.AnchorXProperty, value); } }
		[Parameter] public System.Double AnchorY { set => P.AnchorY = value; get => P.AnchorY; }
		[Parameter] public Xamarin.Forms.Binding BindAnchorY { set { P.SetBinding(Xamarin.Forms.Slider.AnchorYProperty, value); } }
		[Parameter] public Xamarin.Forms.Color BackgroundColor { set => P.BackgroundColor = value; get => P.BackgroundColor; }
		[Parameter] public Xamarin.Forms.Binding BindBackgroundColor { set { P.SetBinding(Xamarin.Forms.Slider.BackgroundColorProperty, value); } }
		[Parameter] public System.Double HeightRequest { set => P.HeightRequest = value; get => P.HeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindHeightRequest { set { P.SetBinding(Xamarin.Forms.Slider.HeightRequestProperty, value); } }
		[Parameter] public System.Boolean InputTransparent { set => P.InputTransparent = value; get => P.InputTransparent; }
		[Parameter] public Xamarin.Forms.Binding BindInputTransparent { set { P.SetBinding(Xamarin.Forms.Slider.InputTransparentProperty, value); } }
		[Parameter] public System.Boolean IsEnabled { set => P.IsEnabled = value; get => P.IsEnabled; }
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.Slider.IsEnabledProperty, value); } }
		[Parameter] public System.Boolean IsVisible { set => P.IsVisible = value; get => P.IsVisible; }
		[Parameter] public Xamarin.Forms.Binding BindIsVisible { set { P.SetBinding(Xamarin.Forms.Slider.IsVisibleProperty, value); } }
		[Parameter] public System.Double MinimumHeightRequest { set => P.MinimumHeightRequest = value; get => P.MinimumHeightRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumHeightRequest { set { P.SetBinding(Xamarin.Forms.Slider.MinimumHeightRequestProperty, value); } }
		[Parameter] public System.Double MinimumWidthRequest { set => P.MinimumWidthRequest = value; get => P.MinimumWidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindMinimumWidthRequest { set { P.SetBinding(Xamarin.Forms.Slider.MinimumWidthRequestProperty, value); } }
		[Parameter] public System.Double Opacity { set => P.Opacity = value; get => P.Opacity; }
		[Parameter] public Xamarin.Forms.Binding BindOpacity { set { P.SetBinding(Xamarin.Forms.Slider.OpacityProperty, value); } }
		[Parameter] public System.Double Rotation { set => P.Rotation = value; get => P.Rotation; }
		[Parameter] public Xamarin.Forms.Binding BindRotation { set { P.SetBinding(Xamarin.Forms.Slider.RotationProperty, value); } }
		[Parameter] public System.Double RotationX { set => P.RotationX = value; get => P.RotationX; }
		[Parameter] public Xamarin.Forms.Binding BindRotationX { set { P.SetBinding(Xamarin.Forms.Slider.RotationXProperty, value); } }
		[Parameter] public System.Double RotationY { set => P.RotationY = value; get => P.RotationY; }
		[Parameter] public Xamarin.Forms.Binding BindRotationY { set { P.SetBinding(Xamarin.Forms.Slider.RotationYProperty, value); } }
		[Parameter] public System.Double Scale { set => P.Scale = value; get => P.Scale; }
		[Parameter] public Xamarin.Forms.Binding BindScale { set { P.SetBinding(Xamarin.Forms.Slider.ScaleProperty, value); } }
		[Parameter] public System.Double ScaleX { set => P.ScaleX = value; get => P.ScaleX; }
		[Parameter] public Xamarin.Forms.Binding BindScaleX { set { P.SetBinding(Xamarin.Forms.Slider.ScaleXProperty, value); } }
		[Parameter] public System.Double ScaleY { set => P.ScaleY = value; get => P.ScaleY; }
		[Parameter] public Xamarin.Forms.Binding BindScaleY { set { P.SetBinding(Xamarin.Forms.Slider.ScaleYProperty, value); } }
		[Parameter] public System.Int32 TabIndex { set => P.TabIndex = value; get => P.TabIndex; }
		[Parameter] public Xamarin.Forms.Binding BindTabIndex { set { P.SetBinding(Xamarin.Forms.Slider.TabIndexProperty, value); } }
		[Parameter] public System.Boolean IsTabStop { set => P.IsTabStop = value; get => P.IsTabStop; }
		[Parameter] public Xamarin.Forms.Binding BindIsTabStop { set { P.SetBinding(Xamarin.Forms.Slider.IsTabStopProperty, value); } }
		[Parameter] public System.Double TranslationX { set => P.TranslationX = value; get => P.TranslationX; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationX { set { P.SetBinding(Xamarin.Forms.Slider.TranslationXProperty, value); } }
		[Parameter] public System.Double TranslationY { set => P.TranslationY = value; get => P.TranslationY; }
		[Parameter] public Xamarin.Forms.Binding BindTranslationY { set { P.SetBinding(Xamarin.Forms.Slider.TranslationYProperty, value); } }
		[Parameter] public System.Double WidthRequest { set => P.WidthRequest = value; get => P.WidthRequest; }
		[Parameter] public Xamarin.Forms.Binding BindWidthRequest { set { P.SetBinding(Xamarin.Forms.Slider.WidthRequestProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindStyle { set { P.SetBinding(Xamarin.Forms.Slider.StyleProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.Slider.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.Slider.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.Slider.BindingContextProperty, value); } }
    }
}
