...
{
    public partial class SwitchCell : ComponentToXamarinBridge<Xamarin.Forms.SwitchCell, SwitchCell>
    {
        public SwitchCell()
        {
        }
        public SwitchCell(Xamarin.Forms.SwitchCell _element):base(_element)
        {
        }

		[Parameter] public System.EventHandler<Xamarin.Forms.ToggledEventArgs> OnChanged { set => P.OnChanged += value; }
		EventCallback<Xamarin.Forms.ToggledEventArgs> _onOnChanged;
		[Parameter] public EventCallback<Xamarin.Forms.ToggledEventArgs> OnOnChanged { set { if (!_onOnChanged.HasDelegate) { P.OnChanged += (s, e) => _onOnChanged.InvokeAsync(e); } _onOnChanged = value; } }
		...
		[Parameter] public Xamarin.Forms.Binding BindOnColor { set { P.SetBinding(Xamarin.Forms.SwitchCell.OnColorProperty, value); } }
		[Parameter] public System.Boolean On { set => P.On = value; get => P.On; }
		[Parameter] public Xamarin.Forms.Binding BindOn { set { P.SetBinding(Xamarin.Forms.SwitchCell.OnProperty, value); } }
		[Parameter] public System.String Text { set => P.Text = value; get => P.Text; }
		[Parameter] public Xamarin.Forms.Binding BindText { set { P.SetBinding(Xamarin.Forms.SwitchCell.TextProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindIsEnabled { set { P.SetBinding(Xamarin.Forms.SwitchCell.IsEnabledProperty, value); } }
		[Parameter] public System.String AutomationId { set => P.AutomationId = value; get => P.AutomationId; }
		[Parameter] public Xamarin.Forms.Binding BindAutomationId { set { P.SetBinding(Xamarin.Forms.SwitchCell.AutomationIdProperty, value); } }
		[Parameter] public System.String ClassId { set => P.ClassId = value; get => P.ClassId; }
		[Parameter] public Xamarin.Forms.Binding BindClassId { set { P.SetBinding(Xamarin.Forms.SwitchCell.ClassIdProperty, value); } }
		...
		[Parameter] public Xamarin.Forms.Binding BindBindingContext { set { P.SetBinding(Xamarin.Forms.SwitchCell.BindingContextProperty, value); } }
    }
}
